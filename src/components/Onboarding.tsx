  ...
  if (shouldOfferTerminalSetup()) {
    steps.push({
      ...
      component: <Box flexDirection="column" gap={1} paddingLeft={1}>
          <Text bold>使用 Doge Code 的终端设置？</Text>
          <Box flexDirection="column" width={70} gap={1}>
            <Text>
              为了获得最佳的编码体验，请为您的终端启用推荐设置：
              <Newline />
              {env.terminal === 'Apple_Terminal' ? 'Option+Enter 用于换行和视觉提示音' : 'Shift+Enter 用于换行'}
            </Text>
            <Select options={[{
            label: '是，使用推荐设置',
            value: 'install'
